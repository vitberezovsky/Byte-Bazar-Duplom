...
<head>
    <title>Управління запасами електронної комерції</title>
...
<body>
    <div class="container1">
        <div class="form-container">
            ...
            <form id="insert-form" action="inventory.php" enctype="multipart/form-data" method="post">
                ...
                <label for="brand">Торгова марка:</label>
                <input type="text" id="brand" name="brand" required>
                <button name="ins" type="submit" class="insert-btn">Зберегти</button>
            </form>
        </div>
                ...
                <div id="product-list">
					...
					if (isset($_GET['pidd'])) {
						...
						echo "<form id='insert-form' action='inventory.php' enctype='multipart/form-data' method='post'>
									...
									<button name='submitt' type='submitt' class='insert-btn'>Зберегти</button>
								</form >";
					}
					if (isset($_POST['search1'])) {
						...
						while ($row = mysqli_fetch_assoc($result)) {
							...
							echo "<tr>
										...
										<td><a href ='inventory.php?pid=$pid' class='insert-btn'>Видалити</button></td>
										<td><a href ='inventory.php?pidd=$pid' class='insert-btn'>Оновити</button></td>
    ...
    <div class="container11">
        <div class="order-container">
            ...
            <div class="btns">
                <a href='inventory.php?a=1'><button id="all-btn">Всі</button></a>
                <a href='inventory.php?d=1'><button id="delivered-btn">Доставлено</button></a>
                <a href='inventory.php?u=1'><button id="undelivered-btn">Недоставлено</button></a>
